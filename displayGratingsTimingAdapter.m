...
stimulator = Cerestim(null_,...
    ...
    stimTable{stimCurrent,"polarity"},...
    stimTable{stimCurrent,"frequency"},...
    stimTable{stimCurrent,"pulses"},...    
    stimTable{stimCurrent,"duration"},...
    stimTable{stimCurrent,"width1"},...
    stimTable{stimCurrent,"width2"});
    %stimTable{stimCurrent,"amplitude"});
%     stimTable{stimCurrent,"amplitude1"},...
%     stimTable{stimCurrent,"amplitude2"});
...
while true
    ...
    goodmonkey(pulse_duration, 'juiceline',1, 'numreward',1, 'pausetime',0, 'eventmarker',25);   % Successful trial, give reward
    break
end
